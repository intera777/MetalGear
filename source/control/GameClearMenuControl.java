...
import model.GameClearMenuModel;

import java.awt.event.KeyEvent;
import java.awt.event.KeyListener;

public class GameClearMenuControl implements KeyListener {
    private GameClearMenuModel model;
    ...
    public GameClearMenuControl(GameClearMenuModel model) {
        this.model = model;
    }
